...
function loadhiststep(nx,ny,n) { let re = new RegExp("[^\d]*(\d+)[^\d]*","g") ; let h = Module.pastehistBox.value; let m = [...h.matchAll(re)]; let moves = m.map((mm) => Number(mm[1])); return moves[n]; }
...
var ___stop_em_js = Module['___stop_em_js'] = 67753;
