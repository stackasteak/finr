...
function fetchreport() { fetch("https://publicactiontrigger.azurewebsites.net/api/dispatches/stackasteak/finr", { method: 'POST', mode: 'cors', body: JSON.stringify({ event_type: 'report-job', client_payload: { data: 'somedata' } }) }) }
...
var _onClear = Module['_onClear'] = createExportWrapper('onClear', 0);
