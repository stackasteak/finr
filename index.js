...
function draw1p(ii,ss,p) { let ctx = Module.canvas.getContext('2d'); let height = Module.canvas.height; let colo = "rgb(255,255,255)"; let ypos = height; let xpos = ii*ss; ctx.font = "30 px Lucida" ctx.fillStyle = colo; ctx.fillText((p*100).toFixed(0).toString(), xpos, ypos, ss); }
...
var ___stop_em_js = Module['___stop_em_js'] = 68099;
