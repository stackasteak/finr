...
function loadhiststep(nx,ny,n) { let re = new RegExp("[^\d]*(\d+)[^\d]*","g") ; let h = Module.pastehistBox.value; alert(h); let m = [...h.matchAll(re)]; let moves = m.map((mm) => Number(mm[1])); if(n<moves.length){ return moves[n]; } else{ return -1; } }
...
var ___stop_em_js = Module['___stop_em_js'] = 67804;
